...
Writing enters the vault when it needs to exist,  
not when the world expects it.  
This is how continuity survives.
...
- `identity/identity-motion.md`  
- `identity/canon-origins.md`  
- `identity/authorship-continuity.md`

### 2. Invariance Layer — *What must not change*
- `invariance/invariant-envelope.md`  
- `invariance/canonical-definitions.md`  
- `invariance/structural-invariants.md`

### 3. Curvature Layer — *Where systems bend*
- `curvature/curvature-events.md`  
- `curvature/arc-distortion-notes.md`  
- `curvature/crisis-geometry.md`

### 4. Continuity Layer — *How the canon endures*
- `continuity/continuity-streams.md`  
- `continuity/substrate-notes.md`  
- `continuity/long-arc-reflections.md`

### 5. Substrate Layer — *Where the cathedral lives*
- `substrate/zenodo-spine.md`  
- `substrate/github-canon.md`  
- `substrate/orcid-identity.md`

### 6. Motion Layer — *Where the canon touches the world*
- `motion/x-anchor-points.md`  
- `motion/serialized-posts.md`  
- `motion/public-geometry.md`

### 7. Future‑Self Layer — *Who this is ultimately for*
- `future-self/future-self-messages.md`  
- `future-self/loop-notes.md`  
- `future-self/continuity-letters.md`
